      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Viktiga milstolpar i fotbollsresan
          </p>
        </div>
              ...
              <div className="flex-1 sm:text-right sm:pr-8 px-4 py-3 max-w-xs sm:max-w-none">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <div className="mt-3 flex items-center justify-end text-sm text-green-600">
                    ...
                    <span>Karriärstart & Utveckling</span>
                  </div>
                </div>
              </div>
            ...
            <div className="relative flex flex-col sm:flex-row items-center">
              ...
              <div className="flex-1 sm:pl-8 px-4 py-3 max-w-xs sm:max-w-none">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <h3 className="text-xl font-bold mb-2">
                    Spelade i Skottsfint
                  </h3>
                  <p className="text-gray-600">
                    Tillbringade sex månader i klubben och utvecklade
                    målvaktsegenskaperna.
                  </p>
            ...
            <div className="relative flex flex-col sm:flex-row items-center">
              <div className="flex-1 sm:text-right sm:pr-8 px-4 py-3 max-w-xs sm:max-w-none">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <h3 className="text-xl font-bold mb-2">Spelade i GAIS</h3>
                  <p className="text-gray-600">
